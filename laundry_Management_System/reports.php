		...
		<div class="card">
			<div class="card-body">
				...
				<div class="row" id="print-data">
					<div style="width:100%">
					<p class="text-center">
						<large><b>Washwiz Report</b></large>
					</p>
					<p class="text-center">
					...
					<table class='table table-bordered'>
						...
						<tbody>
							<?php
								...
								$total = 0;
								$qry = $conn->query("SELECT lo.*, u.fullname 
                                                    FROM laundry_orders lo 
                                                    LEFT JOIN users u ON lo.userID = u.userid 
                                                    WHERE lo.laundry_status = 3 
                                                    AND DATE(lo.date_created) BETWEEN '$d1' AND '$d2' ");
